...
python $EMULATOR_BASE_DIR/find_parameter.py --save-loc $SAVE_DIR --data-loc $DATA_DIR/burgers_shock.mat --base-plot-dir $PLOT_DIR --lossplot-loc $PLOT_DIR/loss_plot.eps --epochs 5000 >> $TRAINING_LOG 2>&1
