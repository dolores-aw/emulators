...
class Parser(argparse.ArgumentParser):
    def __init__(self):
        ...
        #self.add_argument('--N_u2', type=int, required=True, help = 'num of concentrated S_u points')
        #self.add_argument('--N_f2', type=int, required=True, help = 'num of concentrated S_f points')
        #self.add_argument('--m', type=int, required=True, help = 'distance of concentration around x=0')
        #self.add_argument('--time', type = int, required=True, help = 'number of seconds to optimize the parameter lambda')
        # training
