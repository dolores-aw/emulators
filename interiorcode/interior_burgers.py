...
def prepare_nn_inputs_burgers(data_loc, N_u, N_f, random_seed, debugging=False):
    nu = 0.01 / np.pi
    #N_u = 100
    #N_f = 10000
    ...
    return NNInputs_burgers(X_u_train, u_train, X_f_train, lb, ub, nu, X_star, x, t, Exact)
