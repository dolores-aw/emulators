...
python $EMULATOR_BASE_DIR/trainhyperparam.py --save-loc $SAVE_DIR --data-loc $DATA_DIR/burgers_shock.mat --base-plot-dir $PLOT_DIR --lossplot-loc $PLOT_DIR/loss_plot.eps --epochs 10000  >> $TRAINING_LOG 2>&1
